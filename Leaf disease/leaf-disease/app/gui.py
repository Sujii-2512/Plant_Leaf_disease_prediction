...
pic="""MainWindow{
    background-image:url(Downloads/bg1.webp);
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.radioButton_Tensorflow.setGeometry(QRect(320, 145, 200, 20))
        self.tensorlabel = QLabel(self.frame)
        self.tensorlabel.setText("")

        self.tensorlabel.setGeometry(QRect(340, 145, 200, 20))
        ...
        self.radiolabels.setGeometry(QRect(330, 170, 500, 20))
    ...
    def Analyze(self):
        ...
        ImageFile , something = QFileDialog.getOpenFileName(self,"Select Image To Process", "","All Files (*);;Image Files(*.jpg *.gif)",options=options)
        if ImageFile == "":
...
class Window2(QMainWindow):
    def __init__(self, parent=None):
        ...
        highlight_dir = 'C:/Users/Dell/OneDrive/Desktop/leaf-diseases-predition-master/leaf-diseases-predition-master/tests'
